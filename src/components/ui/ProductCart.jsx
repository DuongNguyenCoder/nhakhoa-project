...
const ProductCard = ({ item }) => {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="mt-auto flex items-center justify-between px-4 pb-4 text-sm font-medium">
        ...
        <button
          ...
          className="rounded-full bg-orange-400 px-4 py-1.5 text-sm text-black shadow-md transition-all duration-300 hover:bg-orange-600 hover:text-white"
        >
          Thêm vào giỏ
        </button>
      </div>
