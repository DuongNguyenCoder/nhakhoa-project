...
const Footer = () => {
  return (
    <footer className="bg-red-300 font-sans text-sm">
      <div className="container mx-auto grid grid-cols-1 gap-10 px-6 py-12 lg:grid-cols-4">
        {/* Cột 1: Logo & Thông tin công ty */}
        <div>
          <div className="-mt-16 w-full">
            <img src={logo} alt="logo_footer" className="size-44" />
            <h2 className="-mt-7 mb-4 text-2xl font-bold text-red-900">
              CTY TNHH thương mại dịch vụ y - nha khoa Minh Phương
            </h2>
          </div>
          <div className="flex w-full flex-col gap-1">
            <p className="text-red-800">Mã số thuế: 0107247754</p>
            <p className="text-red-800">Đăng ký ngày: 11/12/2015</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-red-800">
            <li>
              <a href="#" className="transition hover:text-red-950">
                Chính sách bảo mật
              </a>
            </li>
            <li>
        ...
        {/* Cột 3: Liên hệ */}
        <div>
          <h2 className="mb-4 text-xl font-semibold text-red-900">Liên hệ</h2>
          <ul className="space-y-3 text-red-800">
            ...
            <a href="tel:(024)37100625" className="flex items-center gap-2">
              <FaPhoneAlt /> (024) 3710 0625
            </a>
            <a href="tel:(024)32222788" className="flex items-center gap-2">
          ...
          <div className="mt-4 flex gap-4 text-xl text-red-800">
            <a href="#" className="transition hover:text-red-950">
              <FaFacebook />
            </a>
            <a href="#" className="transition hover:text-red-950">
      ...
      {/* Bản quyền */}
      <div className="bg-red-400 py-4 text-center text-xs text-red-950">
