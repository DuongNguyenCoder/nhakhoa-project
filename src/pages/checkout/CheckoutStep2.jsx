...
const CheckoutStep2 = () => {
  ...
  return (
    <div className="container mx-auto grid grid-cols-1 gap-8 p-6 md:grid-cols-2">
      {/* Left: Thông tin người nhận */}
      ...
      <div className="space-y-6 rounded-2xl border bg-gray-50 p-6 shadow">
        ...
        <div className="space-y-1 border-t pt-4 text-base">
          <p>
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-green-600 py-3 font-semibold text-white hover:bg-green-700"
        >
          Tiến hành đặt hàng
        </button>
      </div>
