  ...
  return (
    <div className="min-h-screen bg-gradient-to-r bg-white/80 p-8">
      ...
      <section className="mb-16 text-center">
        <h2 className="text-3xl font-semibold text-indigo-600 mb-4">Về chúng tôi</h2>
      ...
      <section className="text-center mb-16">
        <h2 className="text-3xl font-semibold text-indigo-600 mb-4">Đối tác</h2>
        <p className="text-lg text-gray-700 mb-4">
        ...
        >
          {dataPartner.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="w-[135px] h-[135px] bg-white shadow-lg rounded-full overflow-hidden mx-auto">
                <img src={item.partnerPic} alt={`Partner ${index + 1}`} className="w-full h-full object-cover" />
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
